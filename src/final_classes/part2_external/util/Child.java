package final_classes.part2_external.util;

import final_classes.part10_constructors_review.Parent;
...
public class Child extends Parent {
    ...
    //Another way to initialize final variables is to use a final method
